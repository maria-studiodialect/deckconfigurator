...
const FabricSelection = ({productData, productType}) => {
    ...
    return (
        <div className="bg-beige rounded-b-xl md:shadow-xl">
            <div className="md:px-9 pt-4 md:pt-9">
            <div className="flex justify-between border-t border-charcoal pt-3 md:pt-0 text-sm md:text-md">
            ...
            <div className="hidden md:block"><Link href='/checkout'><button className="p-3 text-center text-sm w-full rounded-b-xl bg-charcoal flex items-center text-beige hover:opacity-50"><span className="w-full">DONE</span></button></Link></div>
        </div>
    )
}
