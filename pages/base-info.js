  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Generated by The Deck Configurator" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <Header fill={ width < 768 ? '#2F2727' : 'white'}/>
      <div className='md:grid grid-cols-2 bg-beige min-h-screen'>
        <div className='relative w-[50vw] h-screen z-0 hidden md:block'>
        <Image src='/bg-img.webp' fill className='object-cover' />
        </div>
      <div className='bg-beige flex justify-center items-center px-7 pt-36 md:pt-0 md:px-24'>
        <div>
