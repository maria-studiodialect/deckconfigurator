...
export default function Details() {
    ...
    return (
        ...
        <div className='flex justify-between items-center mr-14 absolute bottom-0 pb-4 md:pb-7 w-full px-3 md:px-7'>
            <Link href='/base-info'>
            ...
            <Button href='/measurements' mainColour='text-charcoal' text='Next step' icon='#2F2727' />
        </div>
        </>
    )
}
