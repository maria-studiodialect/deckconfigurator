...
export default function Suit() {
    ...
    console.log(opacity);
    const products =  [
        {img:'/safari.webp', title:'Safari Jacket'},
        {img:'/boyfriend.webp', title:'Boyfriend Jacket'},
        {img:'/single-breasted.webp', title:'Single Breasted'},
        {img: '/double.webp', title:'Double Breasted'}, 
    ]
    return (
        <>
        <Head>
        ...
        <div className="h-screen w-screen bg-beige flex justify-center items-center p-7">
            <div>
                <div className='uppercase mb-5 text-sm'>Select your silhouette</div>
