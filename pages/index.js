    ...
    <>
      ...
      <div className="bg-[url('/bg-img.webp')] bg-[68%_0%] bg-cover text-beige h-screen w-screen px-7">
        <div className="flex flex-col h-screen justify-between py-7">
          ...
          <div className='text-[12vw] md:text-[5.5vw] leading-tight md:w-[60%] font-editorial mb-10'>The choice is yours. <br/>
          This is the space to design your own <span className='text-6xl font-shameless md:text-[6.5vw] mr-4 mt-[-20px]'>signature</span> look.
          </div>
